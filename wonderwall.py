...
class Play_Wonderwall:
    def __init__(self, master):
        ...
        self.atual_song = "wonderwall.mp3"
        self.playing = False
        self.paused = False
        self.angle = 0
        ...
        self.gif = Image.open("wonderwallFundo.jpg")
        self.frames = []
        try:
            while True:
        ...
        self.original_cover = make_image_circular("Wonderwall.jpg", tamanho_foto)
